  ...
  return (
    <>
      ...
      <div className="container">
          <label for="token" className="text" ><b>token</b></label>
          <input type="text" placeholder="Enter token" name="token" onChange={(e) => handle(e)} required />
        </div>
        <div className="container">
          <label for="password" className="text" ><b>Password</b></label>
          <input type="text" placeholder="Enter new password" name="password" onChange={(e) => handle(e)}  required/>
        </div>
